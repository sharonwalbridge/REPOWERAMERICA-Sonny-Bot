...
module.exports = (robot) ->
  ...
  robot.respond /quote (.+)/i, (msg) ->
    ...
    robot.http(url).header('Content-Type', 'application/json').header('Authorization', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..0hyPH5SRbjHFjKETQSXi0vx9rNPgJ355Nce4ROWAe9c').post(payload) (err, res, body) ->
      jsonBody = JSON.parse(body)
